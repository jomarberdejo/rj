...
<!-- hello -->
				...
				<a href="admin.php?page=payroll_items" class="nav-item nav-payroll_items"><span class='icon-field'><i class="fa fa-columns"></i></span> Payroll List</a>
				...
				<a href="admin.php?page=deductions" class="nav-item nav-deductions"><span class='icon-field'><i class="fa fa-money-bill-wave"></i></span> Employee Wages Info</a>		
